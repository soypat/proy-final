...
inversión privada.\footnote{Agradecemos a \gls{lia} por hacerse cargo de la compra de todos los elementos necesarios para la fabricación del cohete.}

\medskip

La pandemia azoto duro a todo tipo de acción que se intento tomar, incluso la compra de
componentes, ya no mas la fabricación, se vio afectada, además de las políticas cambiantes de
