...
Esto representa un vuelo de gran aceleración inicial, de mucha violencia, que dificulta la comprobación de sistemas en el que se tienen que tunear los parámetros de control y resolver los problemas de hardware que se vaya presentando. 
