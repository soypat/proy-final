...
\begin{itemize}
    \item Empuje positivo que mantenga altura del vehículo para la máxima actuación del gimbal con empuje restante para poder aumentar la altura solo y recuperar de maniobras inclinadas. \todo{No es un requerimiento que lleve payload según lo propuesto en nuestro documento.}
...
Esta resolución es alimentada como parámetro de actuación en las simulaciones. \todo{No se dice que es aceptable acá (en base a que información decis eso?). Eso es determinado por las simulaciones.}
