...
\todo{juntar estos dos parrafos (arriba y abajo) en uno}
...
(tensiones). Son todos de aluminio y se espera .\todo{corregir esto}
...
\begin{itemize}
    \item Cada pata será dimensionada para soportar 20 veces el peso del vehículo. Este factor de seguridad toma en cuenta la posibilidad de aterrizaje desparejo y el factor dinámico de un impacto \todo{20 veces? Cuantas veces?}
